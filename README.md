...
## 🔗 Live Demo
**[View the Live Experience Here](https://music-visualizer-rust.vercel.app)** *(Recommended: Use headphones for the best experience)*
...
| :--- | :--- | :--- | :--- |
| **Hated by Life Itself** | Kanzaki Iori / Mafumafu | *Kinetic Glitch* | Aggressive typography, camera shake, RGB split. |
| **I'm glad you're evil too** | PinocchioP | *Warm Melancholy* | Firefly particles, dynamic sunset gradients, fading text. |
| **Fix You** | Coldplay | *Organic Light* | Swinging physics lightbulb, rain particles, stadium glow. |
| **Heather** | Conan Gray | *Vintage Film* | Film grain, light leaks, cold breath typography. |
...
* **Kanzaki Iori & Mafumafu** (*Inochi ni Kirawarete Iru*)
* **PinocchioP** (*Kimi mo Warui Hito de Yokatta*)
* **Coldplay** (*Fix You*)
* **Conan Gray** (*Heather*)

*If you are a copyright holder and wish for a track to be removed, please contact me and I will take it down immediately.*
